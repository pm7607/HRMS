...
$fetch_atten = "SELECT * FROM attendance WHERE Employee = '$fetch_emp_r[0]'";
$fetch_atten_res = mysqli_query($conn,$fetch_atten);
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <?php while($fetch_atten_r = mysqli_fetch_array($fetch_atten_res)) {  ?>
                                            <tr>
                                                
                                                <td><?php echo $fetch_atten_r[1]; ?></td>
                                                <td><?php echo $fetch_atten_r[3]; ?></td>
