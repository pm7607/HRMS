                                    ...
                                    if($numrow!=0){
                                         $cnt=1;
                                          ...
                                          while($row = mysqli_fetch_assoc($query)){
                                            $datetime1 = new DateTime($row['formdate']);
                                           ...
                                           echo "<tr>
                                                <td>$cnt</td>
                                                    ...
                                                    <td><a href=\"update_Status_Accept.php?eid={$row['eid']}&descr={$row['descr']}\"><button class='btn-success btn-sm' >Accept</button></a>
                                                    <a href=\"update_Status_Reject.php?eid={$row['eid']}&descr={$row['descr']}\"><button class='btn-danger btn-sm' >Reject</button></a></td>
                                                  </tr>";  
                                         $cnt++; }       
                                    }
                                }
